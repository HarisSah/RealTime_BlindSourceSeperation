...
class BSSApp:
    def __init__(self, root):
        ...
        self.result_signal_1 = None
        self.result_signal_2 = None

        # Create buttons
        self.start_button = tk.Button(root, text="START", command=self.run_ica)
        self.play_button_1 = tk.Button(root, text="PLAY AUDIO 1", command=lambda: self.play_audio(self.result_signal_1, duration=5))
        self.play_button_2 = tk.Button(root, text="PLAY AUDIO 2", command=lambda: self.play_audio(self.result_signal_2, duration=5))
    ...
    def run_ica(self):
        ...
        self.result_signal_1 = S_[:, 0]
        self.result_signal_2 = S_[:, 1]
